class Game{
    ...
    {       var mushroomPositions = [
            ...
            { x: width / 2 - 150, y: height - 1300, image: mushroomImage },
            { x: width / 2 + 250, y: height - 1800, image: mushroomImage },
            { x: width / 2 - 180, y: height - 3300, image: mushroomImage },
           
            { x: width / 2 - 150, y: height - 4300, image: mushroomImage },
            { x: width / 2, y: height - 5300, image: mushroomImage },
